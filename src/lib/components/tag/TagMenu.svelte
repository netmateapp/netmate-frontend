<script lang="ts">
  ...
  import { OtherSuggestedRelationship, ReactiveRelationships, StabilizedRelationship, TagHierarchy, UserSuggestedRelationship, _, type Relationship } from "./tag.svelte";
  ...
  function generateTestRelationships(): Relationship[] {
...
<div class="menu">
  <Tabs bind:this={tabs} />
  <TagSearchBox />
  <TagList {isSpace} hierarchy={getCurrentHierarchy()} relationships={new ReactiveRelationships(generateTestRelationships())} />
</div>
